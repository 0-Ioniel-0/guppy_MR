...
oDPd = int(sys.argv[4])
aDPd = int(sys.argv[5])
f1DPd = int(sys.argv[6])
f2DPd = int(sys.argv[7])
j1DPd = int(sys.argv[8])
j2DPd = int(sys.argv[9])
j3DPd = int(sys.argv[10])
j4DPd = int(sys.argv[11])
j5DPd = int(sys.argv[12])
j6DPd = int(sys.argv[13])
m1DPd = int(sys.argv[14])
m2DPd = int(sys.argv[15])
# Then, the max value.
oDPu = int(sys.argv[16])
aDPu = int(sys.argv[17])
f1DPu = int(sys.argv[18])
f2DPu = int(sys.argv[19])
j1DPu = int(sys.argv[20])
j2DPu = int(sys.argv[21])
j3DPu = int(sys.argv[22])
j4DPu = int(sys.argv[23])
j5DPu = int(sys.argv[24])
j6DPu = int(sys.argv[25])
m1DPu = int(sys.argv[26])
m2DPu = int(sys.argv[27])
# GQ.
GQ = int(sys.argv[28])
# Finally, header length
HD = int(sys.argv[29])
